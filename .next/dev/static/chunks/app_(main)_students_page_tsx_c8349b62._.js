...
"[project]/app/(main)/students/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SkeletonRow = ()=>{
    ...
    if ($[0] !== "e617c29899020d56f98997672287f0da440519dbfbec527d024e38afa4f15aff") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "e617c29899020d56f98997672287f0da440519dbfbec527d024e38afa4f15aff";
    }
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                fileName: "[project]/app/(main)/students/page.tsx",
                lineNumber: 25,
                columnNumber: 30
...
const Students = ()=>{
    ...
    const fetchStudents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Students.useCallback[fetchStudents]": async ()=>{
            if (!token) return;
            try {
                setLoading(true);
                const url = filterStatus ? `${BASE_URL}/api/student/get-all-students?status=${filterStatus}` : `${BASE_URL}/api/student/get-all-students`;
                ...
                setTimeout({
                    "Students.useCallback[fetchStudents]": ()=>setLoading(false)
                }["Students.useCallback[fetchStudents]"], 600);
            }
        }
    }["Students.useCallback[fetchStudents]"], [
        BASE_URL,
        token,
        filterStatus
    ]);
    ...
    const handleAddStudent = async (e)=>{
        ...
        if (!token) return;
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${BASE_URL}/api/student/create-student`, formData, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
    ...
    const handleDelete = async (id)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${BASE_URL}/api/student/delete-student`, {
                headers: {
                    Authorization: `Bearer ${token}`
                },
                data: {
    ...
    const handleLeaveReturn = async (student)=>{
        if (!token) return;
        try {
            if (student.status === "ta'tilda" || student.status === "yakunladi") {
                if (!confirm(`O'quvchini faol holatga qaytarishni tasdiqlaysizmi?`)) return;
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${BASE_URL}/api/student/return-student`, {
                    _id: student._id
                }, {
                    headers: {
                        Authorization: `Bearer ${token}`
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${BASE_URL}/api/student/leave-student`, {
            ...
            console.error("Xato:", err_2.response?.data);
            alert(err_2.response?.data?.message || "Amalda xatolik yuz berdi");
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "border rounded-2xl overflow-visible",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                            ...
                            children: loading ? [
                                ...Array(10)
                                    ...
                                    lineNumber: 203,
                                    columnNumber: 53
                                }, ("TURBOPACK compile-time value", void 0))) : data.filter((s)=>s.first_name.toLowerCase().includes(searchTerm.toLowerCase())).map((student_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                    className: "border-b last:border-0",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            className: "p-4",
                                            children: student_0.first_name
                                        }, void 0, false, {
                                            fileName: "[project]/app/(main)/students/page.tsx",
                                            lineNumber: 204,
                                            columnNumber: 23
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "border px-2 py-1 rounded text-[10px] uppercase font-bold",
                                                children: student_0.status
                                            }, void 0, false, {
                                                fileName: "[project]/app/(main)/students/page.tsx",
                                                lineNumber: 208,
                                                columnNumber: 25
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    onClick: ()=>setActiveMenu(activeMenu === student_0._id ? null : student_0._id),
                                                ...
                                                activeMenu === student_0._id && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "absolute right-4 mt-2 w-48 border rounded-lg z-[100] text-black border-black border-1 shadow-lg bg-white",
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                            onClick: ()=>handleLeaveReturn(student_0),
                                                            className: "w-full text-left px-4 py-2 text-xs border-b hover:bg-gray-50",
                                                            children: student_0.status === "ta'tilda" ? "Markazga qaytarish" : "Ta'tilga chiqarish"
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/(main)/students/page.tsx",
                                                            lineNumber: 218,
                                                            columnNumber: 29
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                            onClick: ()=>handleDelete(student_0._id),
            ...
            isModalOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-white text-black p-6 rounded-xl w-96 border shadow-xl",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                    className: "font-bold",
                                    children: "Yangi student qo'shish"
                                }, void 0, false, {
                                    fileName: "[project]/app/(main)/students/page.tsx",
                                    lineNumber: 234,
                                    columnNumber: 15
...
//# sourceMappingURL=app_%28main%29_students_page_tsx_c8349b62._.js.map