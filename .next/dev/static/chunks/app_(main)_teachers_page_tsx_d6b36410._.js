...
"[project]/app/(main)/teachers/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SkeletonRow = ()=>{
    ...
    if ($[0] !== "c467248f2d6d7dff487e8c98b5efb0a5c65e5c3ac6ec6f31aa2ab83bfc97bac0") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "c467248f2d6d7dff487e8c98b5efb0a5c65e5c3ac6ec6f31aa2ab83bfc97bac0";
    }
    let t0;
...
const Teachers = ()=>{
    ...
    const fetchTeachers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Teachers.useCallback[fetchTeachers]": async ()=>{
            if (!token) return;
            try {
                setLoading(true);
    ...
    }["Teachers.useCallback[fetchTeachers]"], [
        BASE_URL,
        token,
        filterStatus
    ]);
    ...
    const filteredData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Teachers.useMemo[filteredData]": ()=>{
            ...
            return data.filter({
                "Teachers.useMemo[filteredData]": (t)=>`${t.first_name} ${t.last_name} ${t.email}`.toLowerCase().includes(searchTerm.toLowerCase())
            }["Teachers.useMemo[filteredData]"]);
        }
    }["Teachers.useMemo[filteredData]"], [
        searchTerm,
    ...
    const handleFireTeacher = async (id)=>{
        ...
        try {
            const res_0 = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${BASE_URL}/api/teacher/fire-teacher`, {
                headers: {
                    Authorization: `Bearer ${token}`
                },
                data: {
            ...
            if (res_0.status === 200 || res_0.data.status === 200) {
    ...
    const handleReturnTeacher = async (id_0)=>{
        if (!token) return;
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${BASE_URL}/api/teacher/return-teacher`, {
                _id: id_0
            }, {
                headers: {
                    Authorization: `Bearer ${token}`
    ...
    const handleCreate = async (e)=>{
        ...
        if (!token) return;
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${BASE_URL}/api/teacher/create-teacher`, formData, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
            ...
            alert(err_2.response?.data?.message || "Xatolik!");
        }
    };
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                            ...
                            children: loading ? [
                                ...Array(10)
                                    ...
                                    lineNumber: 208,
                                    columnNumber: 53
                                }, ("TURBOPACK compile-time value", void 0))) : filteredData.map((t_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
...
_s(Teachers, "DUGVFEL8UfrI7j1sfh18gOskXcM=", false, function() {
    return [
...
//# sourceMappingURL=app_%28main%29_teachers_page_tsx_d6b36410._.js.map