...
const SkeletonRow = ()=>{
    ...
    if ($[0] !== "8a49dccdcdedbe7fe28939044523ec9c007468033e5e6479726dfc3d53439826") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "8a49dccdcdedbe7fe28939044523ec9c007468033e5e6479726dfc3d53439826";
    }
    let t0;
...
const AdminPanel = ()=>{
    ...
    const fetchAdmins = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdminPanel.useCallback[fetchAdmins]": async ()=>{
            if (!token) return;
            try {
                setLoading(true);
    ...
    }["AdminPanel.useCallback[fetchAdmins]"], [
        BASE_URL,
        token,
        filterStatus
    ]);
    ...
    const filteredData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminPanel.useMemo[filteredData]": ()=>{
            return data.filter({
                "AdminPanel.useMemo[filteredData]": (admin)=>`${admin.first_name} ${admin.last_name} ${admin.email}`.toLowerCase().includes(searchTerm.toLowerCase())
            }["AdminPanel.useMemo[filteredData]"]);
        }
    }["AdminPanel.useMemo[filteredData]"], [
        searchTerm,
    ...
    const handleStatusToggle = async (admin_0)=>{
        if (!token) return;
        const isRestoring = admin_0.status === "ishdan bo'shatilgan";
        if (!confirm(isRestoring ? "Ishga qaytarmoqchimisiz?" : "Ishdan bo'shatmoqchimisiz?")) return;
        try {
            const newStatus = isRestoring ? "faol" : "ishdan bo'shatilgan";
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${BASE_URL}/api/staff/edited-admin`, {
                _id: admin_0._id,
                first_name: admin_0.first_name,
                last_name: admin_0.last_name,
                email: admin_0.email,
                status: newStatus
            }, {
                headers: {
    ...
    const handleDelete = async (id)=>{
        if (!confirm("Haqiqatan ham ushbu adminni bazadan butunlay o'chirmoqchimisiz?")) return;
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${BASE_URL}/api/staff/deleted-admin`, {
                headers: {
                    Authorization: `Bearer ${token}`
                },
                data: {
            ...
            alert(err_1.response?.status === 403 ? "Huquqingiz yetarli emas!" : "Xatolik yuz berdi");
        }
    };
    const openModal = (admin_1 = null)=>{
        if (admin_1) {
            setEditingAdmin(admin_1);
            setFormData({
                first_name: admin_1.first_name,
                last_name: admin_1.last_name,
                email: admin_1.email,
                role: admin_1.role,
                status: admin_1.status || "faol",
                password: ""
            });
        } else {
    ...
    const handleSave = async (e)=>{
        ...
        try {
            if (editingAdmin) {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${BASE_URL}/api/staff/edited-admin`, updatePayload, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${BASE_URL}/api/staff/create-admin`, createPayload, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });
            ...
            alert(err_2.response?.data?.message || "Xatolik yuz berdi");
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "w-full p-4 sm:p-6 min-h-screen",
        children: [
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("thead", {
                                    className: " text-zinc-500 text-[12px] uppercase",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                    className: "text-sm divide-y divide-zinc-800",
                                    children: loading ? // 10 ta skeleton qatori chiqishi uchun massiv yaratamiz
                                    [
                                        ...Array(10)
                                    ].map((_, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SkeletonRow, {}, `skeleton-${index}`, false, {
                                            fileName: "[project]/app/(main)/adminss/page.tsx",
                                            lineNumber: 245,
                                            columnNumber: 46
                                        }, ("TURBOPACK compile-time value", void 0))) : filteredData.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    className: "p-3 text-zinc-400 text-xs font-mono",
                                                    children: item.email
                                                }, void 0, false, {
                                                    fileName: "[project]/app/(main)/adminss/page.tsx",
                                                    lineNumber: 249,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "px-2 py-0.5 rounded bg-zinc-800 border border-zinc-700 text-zinc-400 text-[10px] font-bold uppercase",
                                                        children: item.role
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/(main)/adminss/page.tsx",
                                                        lineNumber: 253,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    className: "p-3",
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: `px-2 py-0.5 rounded-full text-[10px] font-bold border ${item.status === "faol" ? "bg-emerald-500/10 text-emerald-400 border-emerald-500/20" : item.status === "tatilda" ? "bg-amber-500/10 text-amber-400 border-amber-500/20" : "bg-red-500/10 text-red-400 border-red-500/20"}`,
            ...
            isModalOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-background border border-border w-full max-w-md rounded-xl p-6 shadow-lg animate-in zoom-in-95 duration-200",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                    ...
                                    children: editingAdmin ? "Tahrirlash" : "Yangi admin qo'shish"
                                }, void 0, false, {
                                    fileName: "[project]/app/(main)/adminss/page.tsx",
                                    lineNumber: 286,
                                    columnNumber: 15
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                    className: "text-xs font-medium text-muted-foreground uppercase ml-1",
                                                    children: "Ism"
                                                }, void 0, false, {
                                                    fileName: "[project]/app/(main)/adminss/page.tsx",
                                                    lineNumber: 298,
...
_s(AdminPanel, "rvJcipqwDr8Du0XuGGPCrsfbUHY=");
_c1 = AdminPanel;
