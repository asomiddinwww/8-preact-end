...
const Hedaer = (t0)=>{
    ...
    if ($[0] !== "7a094f7af4e2765adc2bcb2ac51ca3ecfcf1343514b637bf48ef8cd74e3dba8f") {
        for(let $i = 0; $i < 72; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "7a094f7af4e2765adc2bcb2ac51ca3ecfcf1343514b637bf48ef8cd74e3dba8f";
    }
    const { isOpen } = t0;
    ...
    const t5 = `fixed left-0 h-screen overflow-y-auto w-[255px] top-0 px-4 transition-all duration-300 ease-in-out ${isOpen ? "w-[255px] px-4" : "w-0 px-0 overflow-hidden border-none opacity-0"}`;
    let t6;
...
_s(RootLayout, "IuSxiCTbwN6dnsoaSfr0leM4C9E=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"]
    ];
});
