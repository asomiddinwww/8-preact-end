...
const Hedaer = ({ isOpen }: HedaerProps) => {
  ...
  const getActiveClass = (path: string) => {
    ...
    return isActive
      ? "flex items-center gap-3 p-2 rounded-lg transition-all border border-foreground/40 bg-accent/50 shadow-sm"
      : "flex items-center gap-3 p-2 rounded-lg transition-all border border-transparent hover:border-foreground/30 hover:bg-accent/20";
  };
  ...
  return (
    ...
    >
      <h2 className="font-semibold my-4">Admin CRM</h2>
      <div className=" border-b border-[#6b6a69]/10">
        <h2 className="font-semibold my-4 pt-4">Menu</h2>
        <ul className="space-y-2">
          ...
          <li className="cursor-pointer">
            <Link className={getActiveClass("/menagers")} href="/menagers">
              <span className="text-xl">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
              ...
              <span>Menagerlar</span>
            </Link>
          </li>
          <li className="cursor-pointer">
            <Link className={getActiveClass("/adminss")} href="/adminss">
              <span className="text-xl">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
          ...
          <li className="cursor-pointer">
            <Link className={getActiveClass("/teachers")} href="/teachers">
              <span className="text-xl">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
          ...
          <li className="cursor-pointer">
            <Link className={getActiveClass("/students")} href="/students">
              <span className="text-xl">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
          ...
          <li className="cursor-pointer">
            <Link className={getActiveClass("/groups")} href="/groups">
              <span className="text-xl">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
          ...
          <li className="cursor-pointer">
            <Link className={getActiveClass("/courses")} href="/courses">
              <span className="text-xl">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
          ...
          <li className="cursor-pointer">
            <Link className={getActiveClass("/payment")} href="/payment">
              <span className="text-xl">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
        ...
        <ul className="space-y-2">
          <li className="cursor-pointer">
            <Link className={getActiveClass("/settings")} href="/settings">
              <span className="text-xl">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
          ...
          <li className="cursor-pointer">
            <Link className={getActiveClass("/profile")} href="/profile">
              <span className="text-xl">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
